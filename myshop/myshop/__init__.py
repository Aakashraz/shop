...
# What happens now?
#
# When you say from myproject import *, Python sees the __all__ list in myproject/__init__.py. It then says, "Aha! The developer has explicitly told me what to expose when * is used. I will only bring in the names listed in __all__."
#
